 ...
 *
 * `users`, `contacts`, `bankAccounts` and `categories` reference the
 * organization with `Restrict` on purpose — nobody should be able to delete
 * an organization by accident through a cascading foreign key. Sessions
 * cascade from their user.
 *
